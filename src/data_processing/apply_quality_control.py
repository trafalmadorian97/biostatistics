...
def apply_decodeme_qc(
    regenie_file: Path, qced_file: Path, out_path: Path, output_mode: OutputMode
):
...
def apply_decodeme_qc_to_all_regenie_files_in_dir(
    regenie_dir: Path, out_dir: Path, qced_file: Path, output_mode: OutputMode
):
