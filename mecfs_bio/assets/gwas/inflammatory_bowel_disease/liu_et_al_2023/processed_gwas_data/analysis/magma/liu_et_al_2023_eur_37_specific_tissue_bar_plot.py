from mecfs_bio.assets.gwas.inflammatory_bowel_disease.liu_et_al_2023.processed_gwas_data.analysis.magma.liu_et_al_2023_eur_37_magma_ensembl_specific_tisssue_gene_sets import (
