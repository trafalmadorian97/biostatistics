...
from mecfs_bio.assets.gwas.me_cfs.decode_me.processed_gwas_data.magma.decode_me_gwas_1_build_37_magma_ensembl_annotations import (
...
DECODE_ME_GWAS_1_MAGMA_ENSEMBL_GENE_ANALYSIS = MagmaGeneAnalysisTask.create(
