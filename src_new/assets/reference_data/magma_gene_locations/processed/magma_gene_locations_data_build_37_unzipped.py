from src_new.assets.reference_data.magma_gene_locations.raw.magma_entrez_gene_location_reference_data_build_37 import (
    MAGMA_ENTREZ_GENE_LOCATION_REFERENCE_DATA_BUILD_37_RAW,
)
from src_new.build_system.task.extraction_one_file_from_zip_task import (
    ExtractFromZipTask,
)
