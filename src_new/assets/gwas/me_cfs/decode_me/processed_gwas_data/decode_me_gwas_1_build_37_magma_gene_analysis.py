...
from src_new.assets.gwas.me_cfs.decode_me.processed_gwas_data.decode_me_gwas_1_build_37_magma_annotations import (
...
from src_new.build_system.task.magma_gene_analysis_task import MagmaGeneAnalysisTask

DECODE_ME_GWAS_1_MAGMA_GENE_ANALYSIS = MagmaGeneAnalysisTask.create(
    asset_id="decode_me_gwas_1_build_37_magma_gene_analysis",
    magma_annotation_task=DECODE_ME_GWAS_1_MAGMA_ANNOTATIONS,
