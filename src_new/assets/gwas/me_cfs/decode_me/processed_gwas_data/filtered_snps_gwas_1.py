from src_new.assets.gwas.me_cfs.decode_me.raw_gwas_data.decode_me_gwas_1 import (
    DECODE_ME_GWAS_1_TASK,
)
from src_new.assets.gwas.me_cfs.decode_me.raw_gwas_data.decode_me_quality_control_snps import (
    DECODE_ME_QC_SNPS,
)
