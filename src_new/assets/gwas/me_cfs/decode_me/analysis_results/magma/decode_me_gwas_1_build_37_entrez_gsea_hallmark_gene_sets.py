...
from src_new.assets.gwas.me_cfs.decode_me.processed_gwas_data.magma.decode_me_gwas_1_build_37_magma_entrez_gene_analysis import (
    DECODE_ME_GWAS_1_MAGMA_ENTREZ_GENE_ANALYSIS,
)
from src_new.assets.reference_data.gene_set_data.for_magma.from_gsea_msigdb.gsea_entrez_human_gene_set_2025_v1_extracted import (
